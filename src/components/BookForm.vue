    ...
    <div class="w-full max-w-lg mx-auto">
        <form class="bg-slate-100 shadow-md px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex justify-between">
                ...
                <button v-if="bookStore.getAction === constants.ACTIONS.EDIT" @click="editBookWithChecks()" class="bg-indigo-400 hover:bg-indigo-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                    Ändern
                </button>
